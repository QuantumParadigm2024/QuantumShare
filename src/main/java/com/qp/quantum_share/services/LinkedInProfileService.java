...
//	ResponseStructure<String> structure;
    ...
    public ResponseEntity<?> getPagesAndProfile(String code, QuantumShareUser user, int userId, String source) {
        try {
            ResponseStructure<String> structure = new ResponseStructure<String>();
            System.out.println("before access");
            String accessToken = getAccessToken(code, source);
    ...
    public String getAccessToken(String code, String source) {
        ...
        if (source != null && source.equals("app")) {
            body.add("redirect_uri", appRedirectUri);
        } else {
